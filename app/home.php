...
<head>
    ...
    <link rel="stylesheet" href="css/my-app.css?<?php echo date("d"); ?>">
</head>
<body>
<div id="app">
        ...
        <div data-name="home" class="page">
            ...
            <div class="navbar ">
                <div class="navbar-inner my_navbar">
                    ...
                    <div class="title my_add_desk">加入餐桌<span class="f7-icons navbar_icon">chevron_down</span></div>
                    <div class="right">
...
<!--                    </div>-->
            ...
            <div class="toolbar">
                <div class="toolbar-inner my_toolbar">
                    ...
                    <a href="#" class="link my_submit_open popup-open" data-popup=".popup-cart">确认点菜</a>
                </div>
            </div>
                    ...
                    <div class="close_cart no-margin">
                            ...
                            <div class="data-table">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <th class="numeric-cell " width="30%"></th>
                                    </tr>
                                    </thead>
                                    <tbody id="cart_list">
                                    <!--
                        ...
                        <div class="toolbar">
                            <div class="toolbar-inner my_toolbar">
                                ...
                                <a href="#" class="link my_submit popup-close">提交订单</a>
                            </div>
                        </div>
...
<script type="text/javascript" src="js/scirpt.js?<?php echo date("d"); ?>"></script>
<script type="text/javascript" src="js/my-app.js?<?php echo date("d"); ?>"></script>
</body>
</html>
